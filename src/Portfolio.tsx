    ...
    return (
        <section id="work" className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 md:px-16 relative">
            ...
            <div className="flex flex-col">
                {isLoading ? (
                    <div className="py-12 text-neutral-500 font-body text-center">Loading projects...</div>
                ) : projects.length === 0 ? (
                    <div className="py-12 text-neutral-500 font-body text-center">No projects available at the moment.</div>
                ) : (
        ...
        >
            ...
            >
                ...
                <div className="mt-4 flex gap-4">
                    <Link to={`/projects/${project.slug || project.id}`} className="inline-flex items-center gap-1 text-xs uppercase tracking-widest text-white border-b border-white pb-1 hover:opacity-80 transition-opacity">
                        View Case <ArrowUpRight size={12} />
                    </Link>
                    {project.link && (
                        <a href={project.link} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-xs uppercase tracking-widest text-neutral-500 border-b border-transparent pb-1 hover:text-white transition-opacity">Live <ArrowUpRight size={12} /></a>
                    )}
                </div>
            </motion.div>
...
const ContactSection: React.FC<ContactSectionProps> = ({ textEnter, textLeave, buttonEnter }) => {
    ...
    return (
        <section id="contact" className="min-h-[60vh] sm:min-h-[80vh] flex flex-col justify-between py-16 sm:py-24 px-4 sm:px-6 md:px-16 bg-neutral-900/20 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start mt-12 md:mt-24 z-10 relative">
                <form onSubmit={handleSubmit} className="flex flex-col gap-6 w-full max-w-lg">
                    <input 
                        ...
                        className="bg-transparent border-b border-neutral-800 pb-3 text-white font-body placeholder:text-neutral-600 focus:outline-none focus:border-white transition-colors"
                        onMouseEnter={buttonEnter}
                        onMouseLeave={textLeave}
                    />
                    <input 
                    ...
                    <textarea 
                        ...
                        className="bg-transparent border-b border-neutral-800 pb-3 text-white font-body placeholder:text-neutral-600 focus:outline-none focus:border-white transition-colors resize-none"
                        onMouseEnter={buttonEnter}
                        onMouseLeave={textLeave}
                    />
                    <button 
                        ...
                        className="self-start text-xs font-body uppercase tracking-[0.2em] border border-neutral-800 px-8 py-4 hover:bg-white hover:text-black transition-all disabled:opacity-50"
                        onMouseEnter={buttonEnter}
                        onMouseLeave={textLeave}
                    >
                        {status === 'loading' ? 'Sending...' : 'Send Message'}
                    </button>
                    {status === 'success' && <p className="text-green-500 font-body text-xs mt-2 uppercase tracking-widest">Message sent successfully!</p>}
                    {status === 'error' && <p className="text-red-500 font-body text-xs mt-2 uppercase tracking-widest">Failed to send message. Try again.</p>}
                </form>
